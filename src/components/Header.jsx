...
export default function Header({
  ...
  return (
    <header className="bg-slate-950/95 dark:bg-slate-950/95 light-mode:bg-white text-white light-mode:text-slate-900 sticky top-0 z-40 border-b border-slate-800 light-mode:border-slate-200 backdrop-blur-md transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 py-2 flex items-center justify-between gap-2 text-xs">
        ...
        <div className="flex items-center gap-2 shrink-0">
          {currentTrip && (
            <button
              onClick={onBack}
              className="p-1.5 rounded-xl bg-slate-900 light-mode:bg-slate-100 hover:bg-slate-800 light-mode:hover:bg-slate-200 text-slate-300 light-mode:text-slate-700 border border-slate-800 light-mode:border-slate-300 transition-all flex items-center gap-1.5 text-xs font-bold shadow-sm"
          ...
          <div className="flex items-center gap-1.5 font-mono text-[11px]">
            {currentTrip?.category === "international" && (
              <div className="flex items-center gap-1 bg-slate-900 light-mode:bg-slate-100 px-2 py-1 rounded-lg border border-slate-800 light-mode:border-slate-200">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse"></span>
                <span className="text-slate-400">🇻🇳</span>
                <strong className="text-amber-400 light-mode:text-amber-600 font-bold">{localTime}</strong>
              </div>
            )}
            <div className="flex items-center gap-1 bg-slate-900 light-mode:bg-slate-100 px-2 py-1 rounded-lg border border-slate-800 light-mode:border-slate-200">
              <span className="text-slate-400">🇮🇳</span>
              <span className="text-slate-300 light-mode:text-slate-700 font-bold">{istTime}</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1 sm:gap-1.5">
            ...
            <button
              ...
              className={"px-2 py-1 rounded-lg border text-[11px] font-bold flex items-center gap-1 transition-all " + (
                seniorMode
                  ...
                  : "bg-slate-900 light-mode:bg-slate-100 text-slate-300 light-mode:text-slate-700 border-slate-800 light-mode:border-slate-300"
              )}
          ...
          <button
            onClick={onOpenSos}
            className="px-2 py-1 bg-rose-950/70 light-mode:bg-rose-100 hover:bg-rose-900 light-mode:hover:bg-rose-200 text-rose-300 light-mode:text-rose-700 border border-rose-500/40 rounded-lg text-[11px] font-extrabold flex items-center gap-1 shadow-sm transition-all active:scale-95"
          ...
          {onOpenDocs && (
            <button
              onClick={onOpenDocs}
              className="px-2 py-1 bg-indigo-950/70 light-mode:bg-indigo-100 hover:bg-indigo-900 light-mode:hover:bg-indigo-200 text-indigo-300 light-mode:text-indigo-700 border border-indigo-500/40 rounded-lg text-[11px] font-bold flex items-center gap-1 transition-all"
          ...
          <button
            ...
            className={"px-2 py-1 rounded-lg border text-[11px] font-bold flex items-center gap-1 transition-all " + (
              isCloudSynced
                ? "bg-emerald-950/60 light-mode:bg-emerald-100 text-emerald-300 light-mode:text-emerald-700 border-emerald-500/40"
                : "bg-slate-900 light-mode:bg-slate-100 text-slate-400 light-mode:text-slate-600 border-slate-800 light-mode:border-slate-300"
            )}
          ...
          <button
            onClick={onLock}
            className="p-1 rounded-lg bg-slate-900 light-mode:bg-slate-100 text-slate-300 light-mode:text-slate-700 border border-slate-800 light-mode:border-slate-300 hover:bg-slate-800 text-[11px]"
            title="Lock Vault"
          >
          ...
          <button
            ...
            className="w-7 h-7 rounded-lg bg-slate-900 light-mode:bg-slate-100 text-slate-300 light-mode:text-slate-700 border border-slate-800 light-mode:border-slate-300 flex items-center justify-center text-xs hover:bg-slate-800 transition-colors"
      ...
      <div className="bg-slate-900/90 light-mode:bg-slate-100 px-3.5 py-1.5 border-t border-slate-800/80 light-mode:border-slate-200 flex items-center justify-between text-xs transition-colors">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-white light-mode:text-slate-900 text-xs truncate">
            {currentTrip ? currentTrip.title : "Travel Architect Master Hub"}
          </span>
        </div>

        <div className="text-[11px] font-mono text-amber-400 light-mode:text-amber-700 font-bold flex items-center gap-1.5">
          <span>{countdown}</span>
        </div>
      </div>
    </header>
