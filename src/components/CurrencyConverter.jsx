  ...
  return (
    <div className="bg-white dark:bg-darkcard p-4 sm:p-5 rounded-2xl border border-slate-200 dark:border-darkborder shadow-sm space-y-4">
      ...
      <div className="space-y-1.5">
        <span className="text-[10px] uppercase font-bold tracking-wider text-slate-500 dark:text-slate-400 block">Quick Presets</span>
            ...
            <button
              ...
              className={"py-2 px-1 rounded-xl text-xs font-mono font-bold transition-all border " + (
                foreignAmount === val
                  ...
                  : "bg-slate-100 dark:bg-slate-950 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700"
              )}
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
        ...
        <div className="bg-slate-50 dark:bg-slate-950 p-3.5 rounded-xl border border-slate-200 dark:border-slate-800 space-y-1">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="w-full bg-transparent text-lg font-mono font-black text-slate-900 dark:text-white focus:outline-none"
              placeholder="0"
            />
        ...
        {/* Indian Rupee Output */}
        <div className="bg-emerald-50 dark:bg-emerald-950/40 p-3.5 rounded-xl border border-emerald-200 dark:border-emerald-500/40 space-y-1">
          <label className="text-[10px] uppercase font-bold text-emerald-800 dark:text-emerald-400 block">
            Estimated Cost ({currency?.targetCode || "INR"})
          </label>
          <div className="flex items-center justify-between">
            <strong className="text-2xl font-black text-emerald-700 dark:text-emerald-300 font-mono">
              ₹{inrValue.toLocaleString()}
            </strong>
            <span className="text-[11px] text-emerald-600 dark:text-emerald-500/80 font-mono">Rate: {rate}</span>
          </div>
        </div>
      </div>
    </div>
